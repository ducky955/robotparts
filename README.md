...
I'm creating a wifi based tex display, which displays a message based on a local server I host. To do this, I will be using wifi enabled microcontrolers to pull messages from text.![alt text](IMG_2306.jpg)
![alt text](image.png)
